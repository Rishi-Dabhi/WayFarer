...
MongoDB, native Stripe sheet, and on-device Gemma are documented in [PLAN.md](city-wallet/PLAN.md) as the fuller architecture. The current map uses native Mapbox, so run it as a development build rather than Expo Go.
